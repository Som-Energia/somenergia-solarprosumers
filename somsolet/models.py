...
class Client(models.Model):
    ...
    file = models.ManyToManyField(
        ClientFile, related_name="clients", verbose_name=_("File")
    )
...
class Project(models.Model):
    name = models.CharField(blank=True, max_length=100, verbose_name=_("Installation"))
    ...
    warning = models.CharField(
        choices=ITEM_WARNINGS, default=_("No Warn"), max_length=100
    )
    ...
    preregistration_date = models.DateField(
        null=True, blank=True, verbose_name=_("Preregistration Date")
    )

    is_paid = models.BooleanField(
        default=False, verbose_name=_("Payed Preregistration")
    )
    ...
    is_cch_downloaded = models.BooleanField(
        default=False, verbose_name=_("CCH downloaded")
    )
    ...
    is_invalid_report = models.BooleanField(
        default=False, verbose_name=_("Invalid Report?")
    )
