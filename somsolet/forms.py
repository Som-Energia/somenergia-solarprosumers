...
class ProjectForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Column(_("campaign"), css_class="form-group col-md-4 mb-0"),
                Column(_("client"), css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column(_("is_invalid_prereport"), css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column(_("status"), css_class="form-group col-md-4 mb-0"),
                Column(_("warning"), css_class="form-group col-md-4 mb-0"),
                Column(_("is_cch_downloaded"), css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
...
class PrereportForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Column(
                    Field("campaign", disabled=True), css_class="col-sm-4 read-only"
                ),
                Column(Field("client", disabled=True), css_class="col-sm-4 read-only"),
                css_class="form-row",
            ),
            Row(
...
class TechnicalVisitForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column("date_technical_visit", css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
        )
        self.helper.layout.append(Submit("previous", "previous"))
...
class SignedContractForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column("upload_contract", css_class="form-group col-md-12 mb-0"),
                css_class="form-row",
            ),
        )
        self.helper.layout.append(Submit("previous", "previous"))
    ...
    class Meta:
        model = Project
        fields = ["date_signature", "upload_contract", "campaign", "client"]
...
class ConstructionPermitForm(forms.ModelForm):
    ...
    class Meta:
        model = Project
        fields = ["date_permit", "upload_permit", "campaign", "client"]
...
class DeliveryCertificateForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column(
                    "upload_delivery_certificate", css_class="form-group col-md-12 mb-0"
                ),
                css_class="form-row",
            ),
        )
...
class LegalizationForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column("upload_legal_docs", css_class="form-group col-md-12 mb-0"),
                css_class="form-row",
            ),
        )
        self.helper.layout.append(Submit("previous", "previous"))
    ...
    class Meta:
        model = Project
        fields = ["date_legal_docs", "upload_legal_docs", "campaign", "client"]
...
class InstallationDateForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column("date_start_installation", css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
        )
        self.helper.layout.append(Submit("previous", "previous"))
    ...
    class Meta:
        model = Project
        fields = ["date_start_installation", "is_date_set", "campaign", "client"]
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                ...
                Column("campaign", css_class="form-group col-md-3 mb-0"),
                Column("client", css_class="form-group col-md-3 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("administrative_division", css_class="form-group col-md-3 mb-0"),
            ...
            Row(
                ...
                Column("tariff", css_class="form-group col-md-4 mb-0"),
                Column("anual_consumption", css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("installation_power", css_class="form-group col-md-4 mb-0"),
                Column("installation_model", css_class="form-group col-md-4 mb-0"),
                Column(
            ...
            Row(
                Column("homemanager", css_class="form-group col-md-4 mb-0"),
                Column("power_meter", css_class="form-group col-md-3 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("acquire_interest", css_class="form-group col-md-6 mb-0"),
                Column("client_comments", css_class="form-group col-md-8 mb-0"),
                Column("engineering_comments", css_class="form-group col-md-8 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("bateries_brand", css_class="form-group col-md-4 mb-0"),
                Column("bateries_model", css_class="form-group col-md-4 mb-0"),
                Column("bateries_power", css_class="form-group col-md-4 mb-0"),
                Column("bateries_capacity", css_class="form-group col-md-4 mb-0"),
                Column("bateries_price", css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("shadow_optimizer", css_class="form-group col-md-4 mb-0"),
                Column("shadow_optimizer_brand", css_class="form-group col-md-4 mb-0"),
                Column("shadow_optimizer_model", css_class="form-group col-md-4 mb-0"),
                Column("shadow_optimizer_price", css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("count_panels", css_class="form-group col-md-4 mb-0"),
                Column("peak_power_panels_wp", css_class="form-group col-md-4 mb-0"),
                Column("panel_brand", css_class="form-group col-md-4 mb-0"),
                Column("panel_type", css_class="form-group col-md-4 mb-0"),
                Column("panel_model", css_class="form-group col-md-4 mb-0"),
            ),
            Row(
            ...
            Row(
                Column("electric_car_charger", css_class="form-group col-md-3 mb-0"),
                Column("charger_brand", css_class="form-group col-md-3 mb-0"),
                Column("charger_manager", css_class="form-group col-md-3 mb-0"),
                Column("charger_manager_brand", css_class="form-group col-md-4 mb-0"),
                Column("charger_manager_model", css_class="form-group col-md-4 mb-0"),
                Column("charger_manager_price", css_class="form-group col-md-4 mb-0"),
                css_class="form-row",
            ),
            Row(
                Column("electric_car", css_class="form-group col-md-4 mb-0"),
                Column(
                    "electric_car_charger_brand", css_class="form-group col-md-4 mb-0"
                ),
                Column(
                    "electric_car_charger_model", css_class="form-group col-md-4 mb-0"
                ),
                Column(
                    "electric_car_charger_power", css_class="form-group col-md-4 mb-0"
                ),
                Column(
                    "electric_car_charger_price", css_class="form-group col-md-4 mb-0"
                ),
            ),
        )
        self.helper.layout.append(Submit("previous", "previous"))
...
class TechnicalCampaignsForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column("price_mono_fixed", css_class="form-group col-md-4 mb-0"),
                Column("price_mono_var", css_class="form-group col-md-4 mb-0"),
                Column("price_tri_fixed", css_class="form-group col-md-4 mb-0"),
                Column("price_tri_var", css_class="form-group col-md-4 mb-0"),
            ),
        )
