...
class TestForms:
    ...
    def test_technicalVisitForm(
        self,
        date_set_technical_visit,
        expected
    ):
        assert TechnicalVisitForm.set_technical_visit(
            self,
            date_set_technical_visit,
        ) == expected
    ...
    def test_constructionPermitForm(
        self,
        date_permit,
        expected
    ):
