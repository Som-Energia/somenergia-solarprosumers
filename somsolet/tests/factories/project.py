...
from .stages import SignatureFileFactory, SignatureFileBaseFactory, PermitFileFactory, OfferReviewFileFactory
...
class ProjectFactory(DjangoModelFactory):
    ...
    offer_review = factory.SubFactory(OfferReviewFileFactory)
    date_permit = None
