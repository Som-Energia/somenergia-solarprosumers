...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('somsolet', '0025_auto_20210823_1214'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True, help_text='last time this object updated', verbose_name='modified at')),
                ('deleted_at', models.DateTimeField(blank=True, help_text='when was deleted this object', null=True, verbose_name='deleted at')),
                ('event_type', models.CharField(choices=[('APPO', 'Appointment'), ('UNAVAIL', 'Unavailability'), ('AVAIL', 'Availability hours')], help_text='Type of this event, Appointment, Unavailability or Availability hours', max_length=64, verbose_name='Event type')),
                ...
                ('project', models.ForeignKey(help_text='Project of this event', on_delete=django.db.models.deletion.CASCADE, to='somsolet.Project', verbose_name='Project')),
            ],
            options={
                'abstract': False,
            },
