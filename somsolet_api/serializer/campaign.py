...
class CampaignSerializer(serializers.HyperlinkedModelSerializer):
    ...
    installationsStatus = serializers.SerializerMethodField(
        "get_installations_status_summary"
    )
    ...
    def get_installations_status_summary(self, obj):
        return {
            ...
            "ongoing": Project.objects.filter(
                campaign__name=obj.name, registration_date__isnull=False
            )
    ...
    def get_production_summary(self, obj):
        ...
        return {
            ...
            "GWhOverSom": ongoing_installations * 1450 * 0.000001 * 100 / 17.0,
        }
