...
class ReportStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "reportDate", "invalidReport", "reportUpload", "status")
...
class SignatureStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "signatureDate", "signatureUpload", "status")
...
class PermitStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "permitDate", "permitUpload", "status")
...
class OfferStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "offerDate", "offerUpload", "status")
...
class OfferAcceptedStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "offerAcceptedDate", "isOfferAccepted", "status")
...
class SecondInvoiceStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "secondInvoiceDate", "secondInvoiceUpload", "status")
...
class LegalRegistrationStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ("id", "legalRegistrationDate", "legalRegistrationUpload", "status")
...
class DeliveryCertificateStageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    deliveryCertificateUpload = serializers.FileField(
        source="delivery_certificate.upload"
    )
