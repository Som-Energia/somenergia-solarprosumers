...
class TestSetTechnicalVisitView:
    def test__set_technical_visit__ok(
        self, authenticated_superuser, calendar, montse_project, rf
    ):
        # given
        ...
        response = ProjectViewSet.as_view({"put": "set_technical_visit"})(
    ...
    def test__set_technical_visit__without_permissions(
        self, authenticated_user, montse_project, calendar, rf
    ):
        # given
